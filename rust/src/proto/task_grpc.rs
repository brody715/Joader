...
const METHOD_TASK_SERVICE_CREATE: ::grpcio::Method<super::task::CreateTaskRequest, super::task::CreateTaskResponse> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/TaskService/Create",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};

const METHOD_TASK_SERVICE_HEART_BEAT: ::grpcio::Method<super::task::HeartBeatRequest, super::task::HeartBeatRespones> = ::grpcio::Method {
    ty: ::grpcio::MethodType::Unary,
    name: "/TaskService/HeartBeat",
    req_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
    resp_mar: ::grpcio::Marshaller { ser: ::grpcio::pb_ser, de: ::grpcio::pb_de },
};
...
impl TaskServiceClient {
    ...
    pub fn create_opt(&self, req: &super::task::CreateTaskRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::task::CreateTaskResponse> {
        self.client.unary_call(&METHOD_TASK_SERVICE_CREATE, req, opt)
    }
    ...
    pub fn create_async_opt(&self, req: &super::task::CreateTaskRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::task::CreateTaskResponse>> {
        self.client.unary_call_async(&METHOD_TASK_SERVICE_CREATE, req, opt)
    }
    ...
    pub fn heart_beat_opt(&self, req: &super::task::HeartBeatRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<super::task::HeartBeatRespones> {
        self.client.unary_call(&METHOD_TASK_SERVICE_HEART_BEAT, req, opt)
    }
    ...
    pub fn heart_beat_async_opt(&self, req: &super::task::HeartBeatRequest, opt: ::grpcio::CallOption) -> ::grpcio::Result<::grpcio::ClientUnaryReceiver<super::task::HeartBeatRespones>> {
        self.client.unary_call_async(&METHOD_TASK_SERVICE_HEART_BEAT, req, opt)
    }
...
pub fn create_task_service<S: TaskService + Send + Clone + 'static>(s: S) -> ::grpcio::Service {
    let mut builder = ::grpcio::ServiceBuilder::new();
    let mut instance = s.clone();
    builder = builder.add_unary_handler(&METHOD_TASK_SERVICE_CREATE, move |ctx, req, resp| {
        instance.create(ctx, req, resp)
    });
    let mut instance = s;
    builder = builder.add_unary_handler(&METHOD_TASK_SERVICE_HEART_BEAT, move |ctx, req, resp| {
